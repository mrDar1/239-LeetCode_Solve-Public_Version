/*problem:
* Return min number of taps that should be open to water the whole garden,
* If the garden cannot be watered return -1.
*
* n == garden len
* ranges[] == range of each different tap*/

/*motivation: first use longest taps then start decrease */

//from editorial - didnt quite get it.

public class B16_MinimumNumberofTapstoOpentoWaterGarden_1326 {
